...
Detta projektet är utstansat från templaten nedan

För att start projektet gå in i en kommandpromt eller skal

Gå till denna katalogen
...
npm run dev
```
(installera npm om du inte har det redan)

Om du har skapat en lokal duckdb från work, kopiera in den till denna katalogen

Sedan koppla upp dig till den genom att byta i settings i ditt program

Om du har laddat upp den till motherduck så kan du koppla upp dig direkt till den på samma ställe i settings istället.
